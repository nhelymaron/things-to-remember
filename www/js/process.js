...
let btn = <div>
  ...
  <div></div>
  				...
  				<button onClick={play} className="bot">Play free music</button>
   				<button onClick={pause} className="bot">Pause the music</button>
		<center><button onClick={stop} className="bot">Stop the music</button></center>
